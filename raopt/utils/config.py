...
DATASETS = ['TDRIVE', 'GEOLIFE', 'FOURSQUARE_NYC', 'FOURSQUARE_GLOBAL', 'FOURSQUARE_SEMANTIC', 'GENERIC_SAMPLE', 'GENERIC', 'GENERIC_HEART', 'GENERIC_HEART_TEST']
MECHANISMS = ['SDD', 'CNOISE', 'BDP_MARKOV']
